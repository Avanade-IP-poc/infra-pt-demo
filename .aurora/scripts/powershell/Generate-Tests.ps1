...
namespace Aurora.Tests.Unit.Services
{
...
// AURORA Generated Integration Test
...
function New-TestConfiguration {
    ...
    switch ($TechStack) {
        "react-dotnet" {
            ...
            $vitestConfig = @"
// AURORA Generated Vitest Configuration
...
<Project Sdk="Microsoft.NET.Sdk">
  ...
  <ItemGroup>
    <ProjectReference Include="..\..\src\backend\Aurora.Api\Aurora.Api.csproj" />
  </ItemGroup>

</Project>
"@
            
            $testProjectPath = "$OutputDir\backend\Aurora.Tests.csproj"
...
"@
        ...
        "python" {
            $pytestConfig = @"
# AURORA Generated pytest configuration
...
# Main execution
Write-Host "🧪 AURORA Test Generator" -ForegroundColor Blue
...
Generated by AURORA Test Generator
