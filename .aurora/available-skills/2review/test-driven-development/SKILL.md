...
```csharp
[Fact]
public async Task RetriesFailedOperationsThreeTimes()
{
    var attempts = 0;
...
Tests-after are biased by your implementation. You test what you built, not what's required. You
verify remembered edge cases, not discovered ones.

Tests-first force edge case discovery before implementing. Tests-after verify you remembered
...
public async Task RejectsEmptyEmail()
{
    ...
    result.Error.Should().Be("Email required");
}
```
