...
**Test-Driven Development (TDD)** is a software development discipline where tests are written
**before** the implementation. The RED-GREEN-REFACTOR cycle is the heartbeat of TDD, ensuring
high-quality, maintainable code with comprehensive test coverage.
...
📘 **See**: [examples/red-phase-examples.md](examples/red-phase-examples.md) for Backend
(.NET/xUnit) and Frontend (TypeScript/Vitest) examples
...
📘 **See**: [examples/green-phase-examples.md](examples/green-phase-examples.md) for minimal
implementation examples and handling complex requirements
...
📘 **See**: [examples/refactor-phase-examples.md](examples/refactor-phase-examples.md) for
Backend/Frontend before/after refactoring examples
...
📘 **See**: [examples/anti-patterns.md](examples/anti-patterns.md) for detailed anti-patterns with
...
TDD provides the **WORKFLOW** (RED → GREEN → REFACTOR), while backend testing provides the **TOOLS**
(xUnit, FluentAssertions, Testcontainers, Moq).
...
- [green-phase-examples.md](examples/green-phase-examples.md) - GREEN phase with complex
  requirements
- [refactor-phase-examples.md](examples/refactor-phase-examples.md) - Before/after refactoring
  examples
