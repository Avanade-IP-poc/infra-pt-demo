...
test("should reject invalid email", () => {
  const service = new UserService();
  expect(() => service.createUser("invalid", "John")).toThrow("Invalid email");
});
...
test("should validate password strength", () => {
  expect(() => validatePassword("weak")).toThrow("Password too weak");
});
...
test("should create order", () => {
  ...
  const service = new OrderService(mockRepo, mockEmail, mockLogger, mockValidator, mockCalculator);
