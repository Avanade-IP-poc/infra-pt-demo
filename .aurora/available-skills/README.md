...
### 1. Almacenamiento en `.aurora/available-skills/`
...
Los **scopes** (en `.aurora/scopes/`) definen cuándo copiar skills:

```yaml
# Ejemplo: .aurora/scopes/frontend/scope.yaml
resources:
...
- El skill se copia desde `.aurora/available-skills/<tech>/<skill>`
...
mkdir -p .aurora/available-skills/<technology>

# Crear skill
mkdir -p .aurora/available-skills/<technology>/<skill-name>

# Crear SKILL.md
code .aurora/available-skills/<technology>/<skill-name>/SKILL.md
```

### 2. Configurar en un Scope

Editar `.aurora/scopes/<scope>/scope.yaml`:
...
- **Scopes**: `.aurora/scopes/README.md`
