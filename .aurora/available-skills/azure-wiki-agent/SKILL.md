...
```powershell
.\.github\skills\azure-wiki-agent\scripts\Sync-DocsToWiki.ps1 -SourcePath "docs/architecture.md"
```

**Sync docs/ folder:**

```powershell
.\.github\skills\azure-wiki-agent\scripts\Sync-DocsToWiki.ps1 -SourcePath "docs/" -Recursive
```

**Preview (dry run):**

```powershell
.\.github\skills\azure-wiki-agent\scripts\Sync-DocsToWiki.ps1 -SourcePath "docs/" -DryRun
```
...
$result = .\.github\skills\azure-wiki-agent\scripts\Convert-MermaidToSvg.ps1 `
  -Content $markdown `
  -BaseName "doc" `
  -OutputPath "."

# Upload SVGs
.\.github\skills\azure-wiki-agent\scripts\Upload-WikiAttachments.ps1 `
...
See: `.github/skills/azure-wiki-agent/scripts/`
...
- Scripts: `.github/skills/azure-wiki-agent/scripts/`
- Examples: `.github/skills/azure-wiki-agent/examples/`
