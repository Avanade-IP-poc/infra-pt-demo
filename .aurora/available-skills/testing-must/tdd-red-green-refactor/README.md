...
Este skill proporciona una guía completa de la metodología Test-Driven Development (TDD) con el
ciclo Red-Green-Refactor, aplicable tanto a backend como frontend.
...
- [red-phase-examples.md](./examples/red-phase-examples.md) - Ejemplos de fase RED para .NET y
  TypeScript
- [green-phase-examples.md](./examples/green-phase-examples.md) - Ejemplos de fase GREEN con
  requisitos complejos
- [refactor-phase-examples.md](./examples/refactor-phase-examples.md) - Ejemplos before/after de
  refactoring
