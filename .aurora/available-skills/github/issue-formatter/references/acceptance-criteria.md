...
**Skill**: `github-issue-creator` **Purpose**: Transform raw notes, error logs, voice dictation, or
screenshots into structured GitHub issues **Focus**: Issue format, structured sections, appropriate
