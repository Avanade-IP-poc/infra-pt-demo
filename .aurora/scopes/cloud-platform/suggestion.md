...
- Restricción de proveedor cloud en constitución: Azure obligatorio (`.aurora/memory/constitution.md`).
...
- Plantilla de guía de despliegue en `.aurora/docs/templates/deployment-guide-template.md`.
...
- `.aurora/memory/constitution.md`
- `.github/workflows/infra-validation.yml`
- `.github/agents/aurora-cicd.agent.md`
- `.aurora/docs/templates/deployment-guide-template.md`
