...
- Skills disponibles de sincronización con Azure DevOps en `.aurora/available-skills/azure-devops-sync`.
...
- `.aurora/memory/constitution.md` — Article XI (CI/CD), Article XIX (Governance)
...
- `.aurora/available-skills/azure-devops-sync/SKILL.md`
