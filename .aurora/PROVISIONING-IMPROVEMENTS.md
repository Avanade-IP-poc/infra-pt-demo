...
**Archivo**: `.aurora/scripts/powershell/Invoke-BoltSetupConstitution.ps1`
...
- Copia core skills desde `.aurora/available-skills/`
...
3. Habilitar algunos items en `.aurora/scopes/backend/scope.yaml` (cambiar `enabled: false` → `enabled: true`)
...
- Ejemplo de Scope: `.aurora/scopes/backend/scope.yaml`
