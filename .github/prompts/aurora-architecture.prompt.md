...
> **Primary Agent**: [Omega Architect](../copilot/agents/aurora-omega-architect.md)  
> **Phase**: Block 3 - Design  
> **Constitution**: **CRITICAL** - Read `memory/constitution.md` FIRST for approved tech stack

## Context

Use this prompt when designing system architecture, creating ADRs, or generating architecture diagrams. This prompt guides Copilot to act as the **Omega Architect Agent** from the AURORA-IA methodology.
