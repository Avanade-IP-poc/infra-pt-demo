...
> **Primary Agent**: [Release Orchestrator](../copilot/agents/aurora-release-orchestrator.md)  
> **Phase**: Block 5 - Release  
> **Constitution**: Read `memory/constitution.md` for CI/CD and deployment policies

## Context

Use this prompt when creating release pipelines, deployment configurations, or generating release notes. This prompt guides Copilot to act as the **Release Orchestrator Agent** from the AURORA-IA methodology.
