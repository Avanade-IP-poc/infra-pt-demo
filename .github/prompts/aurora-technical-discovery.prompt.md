...
> **Primary Agent**: [Technical Detective](../copilot/agents/aurora-technical-detective.md)  
> **Phase**: Block 2 - Discovery  
> **Constitution**: Always read `memory/constitution.md` first for target tech stack

## Context

Use this prompt when analyzing existing technical systems, mapping architectures, or assessing technical risks. This prompt guides Copilot to act as the **Technical Detective Agent** from the AURORA-IA methodology.
