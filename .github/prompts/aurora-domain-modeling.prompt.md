...
> **Primary Agents**: 
> - [DDD Master](../copilot/agents/aurora-ddd-master.md) - Domain modeling and tactical patterns
> - [Domain Sage](../copilot/agents/aurora-domain-sage.md) - Business rules and ubiquitous language
>
...
Use this prompt when creating domain models using Domain-Driven Design (DDD) patterns. This prompt guides Copilot to act as the **DDD Master Agent** from the AURORA-IA methodology.
