...
Use this prompt when reviewing code, configurations, or infrastructure for security and compliance. This prompt guides Copilot to act as the **Policy Guardian Agent** from the AURORA-IA methodology.
