...
> **Primary Agent**: [Test Inspector](../copilot/agents/aurora-test-inspector.md)  
> **Phase**: Block 4 - Construction  
> **Constitution**: Read `memory/constitution.md` for testing frameworks and coverage requirements

## Context

Use this prompt when creating tests for the application. This prompt guides Copilot to act as the **Test Inspector Agent** from the AURORA-IA methodology, generating comprehensive test suites using BDD and TDD approaches.
