...
NUM=$(.github/skills/skill-bolt-adr/scripts/get-next-adr-number.sh docs/decisions)
```
...
# Custom ADR directory
$Num = .\.github\skills\skill-bolt-adr\scripts\Get-NextAdrNumber.ps1 -AdrDirectory "docs/decisions"
```
...
- `.aurora/scripts/bash/create-adr.sh` uses `get-next-adr-number.sh`
- `.aurora/scripts/powershell/Create-ADR.ps1` uses `Get-NextAdrNumber.ps1`
...
```bash
chmod +x .github/skills/skill-bolt-adr/scripts/get-next-adr-number.sh
```
...
```bash
# Test bash script
.github/skills/skill-bolt-adr/scripts/get-next-adr-number.sh
# Expected output: 0001 (if no ADRs exist)

# Test PowerShell script
.\.github\skills\skill-bolt-adr\scripts\Get-NextAdrNumber.ps1
# Expected output: 0001 (if no ADRs exist)
```
