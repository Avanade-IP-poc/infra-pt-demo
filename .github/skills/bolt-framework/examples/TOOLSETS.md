...
```yaml
tools: [search/codebase, search, read/readFile, usages, read/problems, changes, web, 'github/*', read/terminalLastCommand, vscode, agent, 'context7/*', 'microsoftdocs/mcp/*']
```
...
```yaml
tools: [search/codebase, search, read/readFile, edit, execute/runInTerminal, execute/getTerminalOutput, execute/createAndRunTask, read/terminalLastCommand, todo, web, 'github/*', vscode, agent, 'context7/*', 'awesome-copilot/*', 'microsoftdocs/mcp/*', memory]
```
...
```yaml
tools: [search/codebase, search, read/readFile, edit, execute/runInTerminal, execute/getTerminalOutput, web, vscode, agent, 'azure-mcp/*', 'bicep/*', 'microsoftdocs/mcp/*']
```
...
```yaml
tools: [search/codebase, search, read/readFile, edit, execute/runInTerminal, execute/getTerminalOutput, web, vscode, agent, runTests, 'angular-cli/*', 'primeng/*', 'context7/*', 'playwright/*']
```
...
```yaml
tools: [search/codebase, search, read/readFile, edit, vscode, agent, 'ms-mssql.mssql/*', 'context7/*']
```
