...
- Plantillas base por framework frontend soportado.
- Convenciones de estructura de carpetas en `src/frontend`.
- Guías de integración frontend-backend (clientes API, tipado, manejo de errores).
- Checklists de calidad frontend (lint, unit/e2e, accesibilidad básica).
