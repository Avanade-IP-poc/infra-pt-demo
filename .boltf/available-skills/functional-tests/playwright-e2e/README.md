...
Este skill proporciona guías completas y mejores prácticas para testing end-to-end usando Playwright
...
- [../skill-backend-testing-dotnet](../skill-backend-testing-dotnet/) - Integration tests
  relacionados
