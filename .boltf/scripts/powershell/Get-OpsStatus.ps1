...
|---------|------|--------|---------|
| 1.0 | $date | AURORA-IA | Initial version |

---

*Generated by AURORA-IA Ops Command*
"@
...
Write-Host "`n🔍 AURORA-IA Operations Status" -ForegroundColor Magenta
...
Write-Host "  4. Run /aurora.postmortem if incident occurred`n"
