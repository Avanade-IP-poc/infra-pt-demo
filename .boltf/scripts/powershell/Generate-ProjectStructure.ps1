# AURORA Project Structure Generator from Constitution
...
Write-Host "🏗️  AURORA Project Structure Generator" -ForegroundColor Blue
...
This project follows the AURORA methodology with:
...
2. Create your first feature: \`@Aurora Feature\`
...
- \`@Aurora Feature\` - Create new features
- \`@Aurora Implement\` - Generate implementation
- \`@Aurora Testing\` - Generate test suites
- \`@Aurora Docs\` - Generate documentation
...
Write-Host "   4. Create your first feature with @Aurora Feature"
