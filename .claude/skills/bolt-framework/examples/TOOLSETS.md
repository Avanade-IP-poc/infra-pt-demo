...
| ----------------------- | ----------------------------------------------------- | -------- |
| **Azure Cloud**         | `'azure-mcp/*'`, `'bicep/*'`, `'microsoft-docs/*'` | ⭐⭐⭐   |
...
```yaml
tools: [search, read, problems, agent, 'context7/*', 'awesome-copilot/*', 'microsoft-docs/*']
```
...
```yaml
tools:
  [search, read, edit, web, agent, vscode, 'context7/*', 'awesome-copilot/*', 'microsoft-docs/*']
```
...
```yaml
tools:
  [search, read, edit, execute, web, vscode, agent, 'azure-mcp/*', 'bicep/*', 'microsoft-docs/*']
```
...
✅ `'context7/*'`, `'awesome-copilot/*'`, `'microsoft-docs/*'`, `'azure-mcp/*'`, `'bicep/*'`, `'angular-cli/*'`, `'azure-devops/*'`, `'github/*'`, `'playwright/*'`, `'primeng/*'`, `'ms-mssql.mssql/*'`
